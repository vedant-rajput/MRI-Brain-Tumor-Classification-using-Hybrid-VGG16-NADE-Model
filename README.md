...
My first formal research role came during my final year of undergraduate studies at JNTUH, where I worked under faculty supervision in the Department of Computer Science & Engineering on hybrid deep learning architectures for medical image classification. The central research question was whether combining a discriminative CNN feature extractor with a generative distribution model could outperform standard transfer learning baselines in low-data clinical imaging contexts, a setting where data scarcity is a fundamental constraint rather than a temporary obstacle. I led the experimental design, implementation, and evaluation of a hybrid VGG16-NADE architecture, ultimately achieving 97% multi class classification accuracy on MRI brain tumour datasets, a 7-percentage-point improvement over the VGG16 baseline. The work was peer reviewed and published at the 3rd International Conference on Innovations and Recent Trends in Computer Science (ICIRTCS-23-064) in December 2023. Beyond the technical contribution, this experience fundamentally shaped how I approach problems today it taught me that the best results come from hypothesis-driven experimentation, rigorous literature grounding, and a deep respect for reproducibility. It is the experience that continues to anchor my data science philosophy: understand the domain first, engineer with intention, and treat experimental integrity as non-negotiable.

A deep learning pipeline for classifying brain MRI scans into four tumour types
