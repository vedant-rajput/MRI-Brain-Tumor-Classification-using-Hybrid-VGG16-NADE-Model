...
```
Since, vgg16_nade_best.keras is 127.99 (Model) MB and GitHub has a 100 MB file size limit. Make sure to download it from here, and then past the complete folder accordin to the architechture.
